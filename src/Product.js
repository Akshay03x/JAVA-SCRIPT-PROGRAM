...
const Product=()=>{
    var Products=[
        ...
        const formate=Products.map((Pro)=>{
            return(
                <>
                <div class="card col-md-3" >
                    <img src={Pro.ProductImage} class="card-img-top" />
                        <div class="card-body">
                            <h5 class="card-title">{Pro.ProductName}</h5>
                            <p class="card-text">{Pro.ProductDescription}</p>
                            <button className="btn btn-primary">
                                <Link class="nav-link" to={"/PDetail/"+Pro.id}>${Pro.ProductPrice}</Link>
                            </button>
                        </div>
                </div>
                </>
