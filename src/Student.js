...
function Student(){
    var Students=[
        ...
        const FStudent=Students.map((stu)=>{
            return (
            <>
                <div class="card col-md-3" >
                    <img src={stu.avatar} class="card-img-top" />
                        <div class="card-body">
                            <h5 class="card-title">{stu.name}</h5>
                            <Link to="./DetailStu" class="btn btn-primary">Show detail</Link>
                            {/* <BrowserRouter>
                            <Routes>
                            <Route path="./DetailStu" element={<Detail/>}>
                            </Route>
                            </Routes>
                            </BrowserRouter> */}
                        </div>
        ...
        return (
            <>
                <div className="row">{FStudent}</div>
            </>
        );
}
